...
def get_table_names():
    ...
    logger.info(
        f"Current values: USER_USAGE_TABLE_NAME={USER_USAGE_TABLE_NAME}, TOOLSPECS_TABLE_NAME={TOOLSPECS_TABLE_NAME}"
    )
    ...
    if USER_USAGE_TABLE_NAME and TOOLSPECS_TABLE_NAME:
        logger.info("Table names already discovered, skipping discovery")
    ...
    logger.info("Initializing table instances...")
    try:
        ...
        if TOOLSPECS_TABLE_NAME:
            ...
            logger.error("Could not find TOOLSPECS_TABLE_NAME")
